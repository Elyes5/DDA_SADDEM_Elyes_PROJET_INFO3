...
Revision ID: f8bc479d6834
Revises: 
Create Date: 2025-12-28 21:34:19.982816
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['followed_id'], ['user.user_id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['snippet_id'], ['snippet.snippet_id'], ),
    sa.PrimaryKeyConstraint('review_id')
    )
    op.create_table('snippet_topic',
    sa.Column('snippet_id', sa.Integer(), nullable=False),
    sa.Column('topic_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['snippet_id'], ['snippet.snippet_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.topic_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('snippet_id', 'topic_id')
    )
    op.create_table('user_likes_snippet',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('snippet_id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('user_likes_snippet')
    op.drop_table('snippet_topic')
