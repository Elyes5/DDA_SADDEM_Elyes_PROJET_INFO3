...
import { Container, Box, Typography, ThemeProvider, CssBaseline, CircularProgress } from '@mui/material';
...
const MainFeed: React.FC = () => {
  ...
  const filteredSnippets = selectedTopic === 'All' 
    ? snippets 
    : snippets.filter(s => s.language?.toLowerCase() === selectedTopic.toLowerCase());
