...
export const Profile: React.FC = () => {
  ...
  const profile = useAppSelector(
    (state) => state.users.currentUserProfile,
  )
  ...
  const isFollowing =
    authUser?.following_ids?.includes(Number(id)) ?? false
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            ...
            {activeTab === 1 && (
              <Grid container spacing={2}>
                {profile.liked_snippets &&
                profile.liked_snippets.length > 0 ? (
